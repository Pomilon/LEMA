...
def main():
    ...
    notebook_cells.append(create_notebook_cell(
        ...
        "    total = 0\n"
        "    for name in tr.adapter.get_param_names_for_layer(layer_id):\n"
        "        shape = tr.adapter.get_tensor_shape(tr.gbi, name)\n"
        "        n = 1\n"
        "        for d in shape:\n"
        "            n *= d\n"
        "        total += n\n"
        "    return total * tr.vram_flat_buffers[0].element_size()\n"
        "\n"
        ...
        "\n"
        "def run_w8a8(bits, label, backend='auto'):\n"
