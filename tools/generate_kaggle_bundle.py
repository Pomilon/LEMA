...
def main():
    ...
    notebook_cells.append(create_notebook_cell(
        ...
        "vram_delta = wbase[2] - wq8[2]\n"
        "rss_delta = wbase[3] - wq8[3]\n"
        "print(f'step2 time: fp16 {wbase[3]:.0f}ms -> int8 {wq8[3]:.0f}ms ({speedup:.2f}x)')\n"
        "print(f'peak VRAM: fp16 {wbase[2]:.2f}GB -> int8 {wq8[2]:.2f}GB ({vram_delta*1000:+.0f}MB)')\n"
        "print(f'peak RSS: fp16 {wbase[3]:.2f}GB -> int8 {wq8[3]:.2f}GB ({rss_delta*1000:+.0f}MB)')\n"
